...
# Local libraries
from bum.MetricLearningIdentification.utilities.ioutils import *
...
class OpenSetCows2020(data.Dataset):
	...
	def __init__(	self,
		...
		self.__root = "/workspace/bum/MetricLearningIdentification/datasets_copy/OpenSetCows2020"
	...
	def __retrievePositive(self, category, filepath):
		...
		img = loadResizeImage(filepath, self.__img_size)
		return img
	...
	def __retrieveNegative(self, category, filepath):
		...
		possible_categories.remove(category)
  		...
  		# train not used image category
		# not_used_data_list = os.listdir('/workspace/bum/MetricLearningIdentification/datasets_copy/OpenSetCows2020/images/test')
		
		# Randomly select a category
		random_category = random.choice(possible_categories)
		# random_category = random.choice(not_used_data_list)
