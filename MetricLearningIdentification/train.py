...
# CUDA_VISIBLE_DEVICES=2,3 python train.py --out_path=output/ --folds_file=datasets_copy/OpenSetCows2020/splits/10-90-custom.json
...
if __name__ == '__main__':
	...
	parser.add_argument('--num_epochs', nargs='?', type=int, default=1000, 
