...
from bum.MetricLearningIdentification.utilities.loss import *
from bum.MetricLearningIdentification.utilities.mining_utils import *
from bum.MetricLearningIdentification.models.TripletResnet import TripletResnet50
from bum.MetricLearningIdentification.models.TripletResnetSoftmax import TripletResnet50Softmax
from bum.MetricLearningIdentification.datasets_copy.OpenSetCows2020.OpenSetCows2020 import OpenSetCows2020
from bum.MetricLearningIdentification.datasets_copy.OpenSetCows2020.OpenSetCows2020_only_test import OpenSetCows2020 as only_test_OpenSetCows2020
...
class Utilities:
    ...
    def setupForTraining(self, args):
        ...
        if "Reciprocal" in args.loss_function:
            optimiser = optim.NAdam(model.parameters(), lr=args.learning_rate, weight_decay=args.weight_decay)
        else:
            optimiser = optim.NAdam(model.parameters(), lr=args.learning_rate, momentum=0.9, weight_decay=args.weight_decay)
    ...
    def selectDataset(args, train):
        ...
        if args.dataset == "OpenSetCows2020":
            dataset = OpenSetCows2020(  args.current_fold, 
                                        ...
                                        combine=True,
                                        suppress_info=False )
        elif args.dataset == "only_test_OpenSetCows2020":
            dataset = only_test_OpenSetCows2020(  args.current_fold, 
                                        args.folds_file, 
                                        split=split, 
                                        transform=True,
                                        combine=True,
